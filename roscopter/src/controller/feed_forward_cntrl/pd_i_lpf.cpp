...
//
PdILpf::PdILpf(double p, double i, double d, double max, double min, double tau) :
...
//
void PdILpf::setGains(double p, double i, double d, double tau, double max_u, double min_u)
{
