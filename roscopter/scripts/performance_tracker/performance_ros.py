...
class PerformanceROS():
    ...
    def highLevelCommandCallback(self, msg):
        ...
        self.performance.north.high_level_command = msg.x
        self.performance.east.high_level_command = msg.y
        self.performance.down.high_level_command = msg.F
        self.performance.yaw.high_level_command = msg.z

        self.time.receivedCommandTime = msg.header.stamp.secs + msg.header.stamp.nsecs*1E-9
